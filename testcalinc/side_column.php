...
<div id="mc_wrap">
   ...
   dynamic="off"
      ...
      <div id="mc_calendar">
         ...
         <table>
            <thead>
               <tr>
                  <th colspan="1">{if segment_2 != "calendars"}<a id="mc_prev_month" class="icon left" href="{path='testcalmain'}month/{prev_month format="%Y/%m"}/">&laquo;</a>{/if}</th>
                  <th colspan="5"><a href="{path='testcalmain/month'}{month format="%Y/%m"}/">{month format="%F %Y"}</a></th>
                  <th colspan="1">{if segment_2 != "calendars"}<a id="mc_next_month" class="icon right" href="{path='testcalmain'}month/{next_month format="%Y/%m"}/"> &raquo;</a>{/if}</th>
               </tr>
               <tr id="mc_days">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  "><div class="mc_date">{if day_in_current_month}
                     {if day_event_total}<a href="{path='testcalmain/day'}{day format="%Y/%m/%d"}/">{/if}
                     {day}
   ...
   {/exp:calendar:cal}
					...
					<ul>
						...
						<li><a href="{path=testcalmain/calendars}{calendar_url_title}/">{calendar_title}</a></li>
