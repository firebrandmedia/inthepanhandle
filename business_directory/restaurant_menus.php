...
<title>Local Restaurant Menus for Download / Viewing | Business Directory | InThePanhandle.com | Your Eastern WV Community Website</title>
...
<ul>
{exp:weblog:entries weblog="restaurant_menus" orderby="title" sort="asc"}
<li><h2>{title}</h2> <p><a href="{title_permalink=business_directory/menu}">{title} Menu</a></p>
<div class="clear_both"></div></li>
{/exp:weblog:entries}
</ul>
</div>
</div>
<div id="back_full"><div id="back"><a href="{path='SITE_INDEX'}/business_directory/cat_listings/category/restaurants_dining/">View our complete Restaurant Directory</a></div></div>
<div id="footer">
<div id="footer_nav">
<div id="destination">
