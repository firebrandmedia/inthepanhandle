{embed="testcalinc/index" page_title="Calendars"}
</head>
<body id="home">
...
<div class="calendars">
    <h4><small>View events in this Calendar by: <b><a href="{path='testcalmain/month/by_calendar'}{calendar_url_title}/">Month</a></b> | <b><a href="{path='testcalmain/week/by_calendar'}{calendar_url_title}/">Week</a></b> | <b><a href="{path='testcalmain/day/by_calendar'}{calendar_url_title}/">Day</a></b><br /><a href="{path='testcalmain/export/calendar'}{calendar_id}/">Export this Calendar's Events to another Application</a></small>{calendar_title}</h4>
...
{exp:calendar:calendars calendar_name="not {segment_3}" dynamic="off"}
    <li class="title"><small>View events in this Calendar by: <b><a href="{path='testcalmain/month/by_calendar'}{calendar_url_title}/">Month</a></b> | <b><a href="{path='testcalmain/week/by_calendar'}{calendar_url_title}/">Week</a></b> | <b><a href="{path='testcalmain/day/by_calendar'}{calendar_url_title}/">Day</a></b></small>{calendar_title}</li>
{/exp:calendar:calendars}
