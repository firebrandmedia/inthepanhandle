...
<title>More Destination Pages at InThePanhandle.com | Your Eastern WV Community Website</title>
...
<div id="body_content">
<div id="more_content">
<h1>Our Navigation Menu is bursting at the seams… But we have more for you to explore!</h1>
<ul>
<li><a href="{path='SITE_INDEX'}/business_directory/restaurant_menus/" title="Eastern WV Restaurant Menus">Restaurant Menus</a> Download PDF menus from your favorite local restaurants.  Remember the menu drawer? Buh-Bye!</li>
<li><a href="{path='SITE_INDEX'}/gov/" title="Directory of Local Government Offices">Local Gov.</a> Don't call me, I'll call you. For those times when you need to speak to a local bureaucrat.</li>
<li><a href="{path='SITE_INDEX'}/media/rss_feeds/" title="InThePanhandle.com RSS Feeds">RSS Feeds</a> If you know what this is, then here they are.  Otherwise, nothing to see here.</li>
<li><a href="http://twitter.com/inthepanhandle" title="InThePanhandle.com on Twitter">Twitter.com/InThePanhandle</a> We like Twitter, and use it. You don't?</li>
<li><a href="http://www.facebook.com/inthepanhandle" title="InThePanhandle.com on Facebook">ITP on Facebook</a> Become a fan of InThePanhandle.com? We won't bite. Spreading wild rumors and posting your HS yearbook photo… that's another story.</li>
<li><a href="http://www.flickr.com/groups/inthepanhandle/" title="Eastern WV Flickr Photo Group"> Eastern WV Flickr Photo Group.</a>  Share your local photos here.</li>
<li><a href="{path='SITE_INDEX'}/search/advanced" title="Advanced Search Form">Advanced Search</a> I'm not saying that we have super-intelligent extraterrestrial beings that help you do the search, but…</li>
<li><a href="{path='SITE_INDEX'}/support/tutorials/" title="Video Tutorials on how to use InThePanhandle.com">Video Tutorials</a> Need some help getting around InThePanhandle.com? Give our video tutorials a whirl!</li>
</ul>
</div>
</div>
<div id="footer">
