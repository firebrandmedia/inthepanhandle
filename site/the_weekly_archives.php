...
<title>The Weekly, Email Newsletter | Archives | InThePanhandle.com | Your Eastern WV Community Website</title>
...
<h1>The Weekly</h1>
<p class="article_author">InThePanhandle.com Email Newsletter Archives</p>

<p>The Weekly is our vision for a digital weekly newspaper for the Eastern Panhandle of West Virginia. Each week we will highlight upcoming events, popular news and new businesses from around the Eastern Panhandle. The same kinds of things that make up a small local newspaper.</p>

<script type="text/javascript" src="http://email.firebrand-media.com/t/r/p/kkdij/10/1/0/1/0/"></script>
<br /><br />

<h3>Sign-up to receive The Weekly</h3>
<form action="http://email.firebrand-media.com/t/r/s/jytitd/" method="post">
<div id="newsletter_sign_up">
<p><label for="jytitd-jytitd">Email Address:</label><br /><input type="text" class="txt" name="cm-jytitd-jytitd" id="jytitd-jytitd" /> <input class="btn" type="submit" value="Subscribe" /></p>
</div>
</form>
