...
<title>Tweeting in the Panhandle | InThePanhandle.com | Your Eastern WV Community Website</title>
...
<link href="/css/itp.css" rel="stylesheet" type="text/css">
<link rel="apple-touch-icon" href="http://inthepanhandle.com/images/ui/iphonetouch.jpg">
<script type='text/javascript' src='/js/jquery-1.2.1.pack.js'></script>
<script>
var refreshId = setInterval(function()
{
     $('#responsecontainer').fadeOut("slow").load('http://www.inthepanhandle.com/index_10.php/embeds/twitter_search/').fadeIn("slow");
}, 30000);
</script>
...
<div id="body_content">
<div id="tweeting">
<h1>Tweeting in the Panhandle</h1>
<p>A real-time stream of "tweets" that include any of the following: #ITPWV, Martinsburg, Berkeley Springs, and Shepherdstown.</p>
</div>
<div id="responsecontainer">
{embed="embeds/twitter_search"}
</div>
</div>
<div id="footer">
<div id="footer_nav">
