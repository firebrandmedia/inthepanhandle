...
{exp:channel:entries channel="news" orderby="date" sort="desc" limit="5" dynamic="off" category="390"}

<div class="story">
<a href="{title_permalink=news/article}">{article_images}
{exp:ce_img:pair src="{article_image}" height="180" width="180" crop="yes" smart_scale="yes"}
<img src="{made}" class="article_image" />
{/exp:ce_img:pair}
{/article_images}</a>
...
<div id="ads">
<!--Email Newsletter Signup Global Variable-->
    <div id="email">
<h3>Sign Up for <em>The Weekly</em></h3>
<p>Our weekly email delivered every Friday morning packed with upcoming events, local stories and new local businesses.  <br /><a href="http://www.inthepanhandle.com/local/site/the_weekly_archives/">View the archives.</a></p>
<form action="http://email.firebrand-media.com/t/r/s/jytitd/" method="post" id="subForm">
<p><label for="jytitd-jytitd">Email:</label> <input type="text" name="cm-jytitd-jytitd" id="jytitd-jytitd" /> <input type="submit" value="Subscribe" /></p>
</form></div>
<!--Email Newsletter Signup Global Variable-->
</div>
</div>
...
<ul>
{exp:channel:entries channel="news" orderby="date" offset="0" sort="desc" limit="6" dynamic="off" disable="categories|category_fields|member_data|trackbacks|pagination|custom_fields"}
