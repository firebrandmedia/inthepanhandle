...
{embed="copkinc/header"}
		...
		<div id="maincolumn">
			...
			<div id="leftcolumn">
				...
				<h4>Things could be better!</h4>
				<p>The Solspace <a href="http://www.solspace.com/software/detail/friends/">Friends</a> add-on allows your users to submit status updates on your EE site. Combined with the Solspace Facebook Connect add-on, you can have those statuses also published directly to Facebook.</p>
				<p>If already have Friends installed...</p>
				<h5><a href="{path='copkmain/status_update_friends'}">Click here to proceed to the pre-configured template</a></h5>
