{embed="copkinc/index" page_title="Registration"}
</head>
<body id="home">
		...
		<div id="maincolumn">
			...
			<div id="leftcolumn">
				...
				{exp:fbc:registration
					return_on_success="copkmain/status/registered"
					width="600"
					border_color="#ffffff"
				}

				{if logged_in}
					<p>You are currently logged into ExpressionEngine on this site. You must be logged out of EE to view the Registration form</p>
				{/if}
...
{embed="copkinc/side_column"}
				...
				<div id="aboutcolumn">
					...
					<p>The "Register" page uses the Facebook Registration plugin to display a simple registration form. Any users that are not logged into EE will be able to see the form. Once registration is complete, an EE account will be created and synced to the users' Facebook account.</p>

					<p>It makes use of the following tags:</p>

					<ul>
						<li><a href="http://www.solspace.com/docs/detail/fbc_fb_registration/">FBC:Registration</a> to display the Facebook Registration form.</li>
