...
<title>InThePanhandle.com RSS Feeds | Your Eastern WV Community Website</title>
...
<div id="body_content">
<div id="more_content">
<h1>Feed your RSS reader with feeds from InThePanhandle.com</h1>
<ul>
<li><a href="{path='SITE_INDEX'}/media/news_rss/" title="News, Articles and Press Release RSS Feed">News & Articles</a> Our News, Articles and Press Release RSS Feed</li>
<li><a href="{path='SITE_INDEX'}/media/events_rss/" title="Event Calendar RSS Feed">Event Calendar</a> Our Event Calendar RSS Feed</li>
<li><a href="{path='SITE_INDEX'}/media/business_rss/" title="New Businesses RSS Feed">Business Directory</a> Recently added businesses to the Business Directory RSS Feed</li>
<li><a href="{path='SITE_INDEX'}/media/products_rss/" title="New Products in the InThePanhandle.com Shop Local Marketplace">Shop Local</a> Recently added Products in the InThePanhandle.com Shop Local Marketplace RSS Feed</li>
<li><a href="{path='SITE_INDEX'}/media/blog_rss/" title="InThePanhandle.com Blog RSS Feed">ITP Blog</a> Our Blog RSS Feed</li>
<li><a href="{path='SITE_INDEX'}/media/coupons_rss/" title="New Coupons in the InThePanhandle.com Shop Local Marketplace">Coupons</a> Recently added Coupons in the InThePanhandle.com Shop Local Marketplace RSS Feed</li>
<li><a href="http://feeds.feedburner.com/UploadsFromInthepanhandlecom" title="Recently added images to our Flickr Photo Stream">Flickr Feed</a>Recently added images to our Flickr Photo Stream</li>
</ul>
</div>
<p class="having_trouble">Don't know what RSS is?  Let <a href="http://en.wikipedia.org/wiki/RSS" title="RSS defined by Wikipedia">Wikipedia</a> explain it.</p>
</div>
<div id="footer">
<div id="footer_nav">
<div id="destination">
