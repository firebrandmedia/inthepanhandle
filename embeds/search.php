...
<p><label for="keywords">I'm looking for…</label><input class="txt" type="text" name="keywords" id="keywords" value="" size="18" maxlength="100" /><input type="submit" value="Search" class="search_btn" /></p>
