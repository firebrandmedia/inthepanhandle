...
<h1>Howdy, neighbor. Welcome to the neighborhood!</h1>
<p>Thanks for your interest in an InThePanhandle.com user account. Your User Account will allow you to add articles to our news section, events to our calendar and the ability to save content (articles, business listings, events, coupons, etc.) in your account for quick reference.</p>
...
<p><label for="username">Email Address:*</label> <input class="txt" id="username" name="username" size="20" type="text" /></p>
