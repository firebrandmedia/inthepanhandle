...
<title>Eastern WV News, Articles, Commentary and More | InThePanhandle.com | Your Eastern WV Community Website</title>
...
<div id="other_news_feeds">
<h2>Local, State and World News (Grab your coffee and get caught up)</h2>
<div id="other_news">
<h3>WV State & Local News</h3>
<a href="http://news.google.com/news?svnum=10&ie=UTF-8&as_drrb=q&as_qdr=&as_mind=1&as_minm=10&as_maxd=31&as_maxm=10&q=west+virginia+berkeley+OR+morgan+OR+jefferson+OR+martinsburg&output=rss&ned=:ePkh8BM9ExLS4stNLCrJzCtOKi1KVygvM2ATktOSUSrOSC3ISC1KUQjNyyxLLSrOLKlUUvAtLUpJLRJiBbrGgBVmrQajkcDRLvbkjdxrOrI59t7wiT8eBACXzhvo" title="Google News, WV News RSS Feed"><img class="rss_subscribe" src="/images/ui/rss.png"/></a>
{exp:magpie url="http://news.google.com/news?svnum=10&ie=UTF-8&as_drrb=q&as_qdr=&as_mind=1&as_minm=10&as_maxd=31&as_maxm=10&q=west+virginia+berkeley+OR+morgan+OR+jefferson+OR+martinsburg&output=rss&ned=:ePkh8BM9ExLS4stNLCrJzCtOKi1KVygvM2ATktOSUSrOSC3ISC1KUQjNyyxLLSrOLKlUUvAtLUpJLRJiBbrGgBVmrQajkcDRLvbkjdxrOrI59t7wiT8eBACXzhvo" limit="5" refresh="720"}
<ul>
{items}
...
<div id="other_news">
<h3>World News</h3>
<a href="http://news.google.com/news?ned=us&rec=0&output=rss" title="Google News, World News RSS Feed"><img class="rss_subscribe" src="/images/ui/rss.png"/></a>
{exp:magpie url="http://news.google.com/news?ned=us&rec=0&output=rss" limit="5" refresh="720"}
<ul>
{items}
<li><a href="{link}">{title}</a></li>
{/items}
...
<div id="other_news">
<h3>Sports News</h3>
<a href="http://news.google.com/news?pz=1&ned=us&hl=en&topic=s&output=rss" title="Google News, Sports RSS Feed"><img class="rss_subscribe" src="/images/ui/rss.png"/></a>
{exp:magpie url="http://news.google.com/news?pz=1&ned=us&hl=en&topic=s&output=rss" limit="5" refresh="720"}
<ul>
{items}
<li><a href="{link}">{title}</a></li>
{/items}
...
<div id="other_news">
<h3>Tech News</h3>
<a href="http://news.google.com/news?pz=1&ned=us&hl=en&topic=t&output=rss" title="Google News, Tech News RSS Feed"><img class="rss_subscribe" src="/images/ui/rss.png"/></a>
{exp:magpie url="http://news.google.com/news?pz=1&ned=us&hl=en&topic=t&output=rss" limit="5" refresh="720"}
<ul>
{items}
<li><a href="{link}">{title}</a></li>
{/items}
...
<a href="http://news.google.com/news?pz=1&ned=us&hl=en&topic=b&output=rss" title="Google News, Financial / Business News RSS Feed"><img class="rss_subscribe" src="/images/ui/rss.png"/></a>
{exp:magpie url="http://news.google.com/news?pz=1&ned=us&hl=en&topic=b&output=rss" limit="5" refresh="720"}
<ul>
{items}
<li><a href="{link}">{title}</a></li>
{/items}
...
<a href="http://news.google.com/news?pz=1&ned=us&hl=en&topic=e&output=rss" title="Google News, Entertainment News RSS Feed"><img class="rss_subscribe" src="/images/ui/rss.png"/></a>
{exp:magpie url="http://news.google.com/news?pz=1&ned=us&hl=en&topic=e&output=rss" limit="5" refresh="720"}
<ul>
{items}
<li><a href="{link}">{title}</a></li>
{/items}
