...
<title>{exp:weblog:category_heading weblog="itp_blog" disable="categories|category_fields|pagination|member_data|trackbacks|custom_fields"}{category_name}{/exp:weblog:category_heading} | News Archives | InThePanhandle.com | Your Eastern WV Community Website</title>
...
{exp:weblog:category_heading weblog="itp_blog"}
<h1>{category_name}</h1><span class="bread_crumb"> / {embed="embeds/category_breadcrumbs" cat_id="{category_id}" type="name"} <a href="{path='SITE_INDEX'}/itp_blog/">News Archives</a> / <a href="{path='SITE_INDEX'}">Home</a></span>
<div class="clear_both"></div>
...
<div id="back_full"><div id="back"><a href="{path='SITE_INDEX'}/itp_blog/">Back to the InThePanhandle.com News Page</a></div></div>
<div id="footer">
<div id="footer_nav">
